...
const translations = {
  de: {
    ...
    // ── Main screen ────────────────────────────────────
    appSub:             "Aktueller Spotpreis für Strom",
    ...
    fixedActiveSub:     "Spotmarktpreise als Orientierung · Dein Fixpreis bleibt unverändert",
    notifyPrompt:       "🔔 Benachrichtigung?",
    notifyYes:          "Ja, bitte",
  ...
  en: {
    ...
    // ── Main screen ────────────────────────────────────
    appSub:             "Current spot price for electricity",
    ...
    fixedActiveSub:     "Spot prices shown as reference · Your fixed price remains unchanged",
    notifyPrompt:       "🔔 Notifications?",
